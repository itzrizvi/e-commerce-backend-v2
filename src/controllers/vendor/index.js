module.exports = {
    createVendorController: require("./createVendorController"),
    updateVendorController: require("./updateVendorController"),
    ...
    getContactPersonController: require("./getContactPersonController"),
}