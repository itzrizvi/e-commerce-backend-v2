const { addProductConditionController, updateProductConditionController } = require("../../../controllers");

module.exports = {
    addProductCondition: async (root, args, { db, user, isAuth, TENANTID }, info) => {
